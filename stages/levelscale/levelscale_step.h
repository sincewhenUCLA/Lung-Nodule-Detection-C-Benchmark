/**
 * levelscale_step.h: this file is part of the ALNSB project.
 *
 ...
 *
 */
#ifndef ALNSB_LEVELSCALE_STEP_H
# define ALNSB_LEVELSCALE_STEP_H
...
extern
void levelscale_cpu (s_alnsb_environment_t* __ALNSB_RESTRICT_PTR env,
