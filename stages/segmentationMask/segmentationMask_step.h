/**
 * segmentationMask_step.h: this file is part of the ALNSB project.
 *
 ...
 *
 */
#ifndef ALNSB_SEGMENTATIONMASK_STEP_H
# define ALNSB_SEGMENTATIONMASK_STEP_H
...
#endif //!ALNSB_SEGMENTATIONMASK_STEP_H
